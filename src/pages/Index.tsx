        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="text-center p-6 rounded-2xl bg-card hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 animate-slide-up opacity-0" style={{ animationDelay: '300ms' }}>
              <div className="inline-flex items-center justify-center w-20 h-20 bg-accent rounded-full mb-6 transition-transform hover:scale-110 shadow-lg">
      ...
      <section className="py-20 bg-gradient-to-b from-background to-secondary/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-6 text-primary animate-fade-in">
              Our Services
            </h2>
